...
ca09_sera_full <- readRDS(here::here("data", "processed_data", "ca09sera_full.rds"))
p1_mab_full <- readRDS(here::here("data", "processed_data", "p1mab_full.rds"))
p1_sera_full <- readRDS(here::here("data", "processed_data", "p1sera_full.rds"))
antibody_key <- readRDS(here::here("data", "processed_data", "antibody_key.rds"))
...
ggsave(here::here("results", "figures", "supp_sera_pca.png"), plot = sera_pca_fig)
```
...
ggsave(here::here("results", "figures", "supp_ca09_pca.png"), plot = supp_ca09_pca)
```
...
ggsave(here::here("results", "figures", "supp_p1_pca.png"), plot = supp_p1_pca)
```
