...
```
I need to reorder the groups of the radar graphs so that they  are grouped by antigenicity, this will be just moving the columns around. Need to figure out how to put on legend titles or graph titles. Also need to adjust the 


## Univariate analysis

```{r}
knitr::include_graphics(here::here("results", "figures", "univariate_antigen.png"))
